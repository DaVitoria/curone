            ...
            <div class="page-content-inner">
                ...
                <div class="section-header mb-lg-2 border-0 uk-flex-middle">
                    <div class="section-header-left">
                        <h2 class="uk-heading-line text-left"><span> Instrutores </span></h2>
                    </div>
                    <div class="section-header-right">
                        ...
                        <div class="display-as">
                            <a href="your-laked-videos.html" class="active" uk-tooltip="title: Veiw as Grid; pos: top-right" title="" aria-expanded="false">
                                <i class="icon-feather-grid"></i>
                            </a>
                        </div>

                        <a href="#" class="btn btn-default uk-visible@s"> <i class="uil-plus"></i> Novo Instrutor</a>
                ...
                <div class="uk-child-width-1-4@m uk-child-width-1-2@s" uk-grid="" uk-scrollspy="cls: uk-animation-slide-bottom-small; target: > div ; delay: 200">
                    ...
                    <div>
                        ...
                        <div class="card animate-this">
                            <div class="card-body text-center">
                                <div class="avatar-parent-child">
                                    <img alt="Image placeholder" src="{{asset('assets\images\avatars\avatar-3.jpeg')}}" class="avatar  rounded-circle avatar-lg">
                                    <span class="avatar-child avatar-badge bg-success"></span>
                                </div>
