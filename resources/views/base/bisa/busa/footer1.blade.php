<footer class="container-fluid pt-5">
    <div class="container">
        <h2 class="logo text-center">Online</h2>
    ...
    <div class="copyright mt-4">
        <p class="text-center">&copy; 2023 <a href="#" class="text-white">Vick'Clands</a>. Programador
            by <a href="https://davitoria.github.io/vick" target="_blank" class="text-white">DaVick</a>.</p>
    </div>
</footer>
