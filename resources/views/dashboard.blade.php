                ...
                <div class="card-body">
                    <div class="uk-flex-middle" uk-grid="">
                        ...
                        <div class="uk-width-expand">
                            <img src="{{asset('assets\images\demos\d-sales.png')}}" alt="">
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="uk-flex-middle" uk-grid="">
                        ...
                        <div class="uk-width-expand">
                            <img src="{{asset('assets\images\demos\d-student.png')}}" alt="">
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="uk-flex-middle" uk-grid="">
                        ...
                        <div class="uk-width-expand">
                            <img src="{{asset('assets\images\demos\d-graduation.png')}}" alt="">
                        </div>
                    </div>
                </div>
    ...
    <ul class="uk-slider-items uk-child-width-1-3@m uk-child-width-1-2@s pb-3 uk-grid">
        ...
        <li>
                <div class="card">
                        ...
                        <div class="card-body text-center">
                            <div class="avatar-parent-child">
                                <img alt="Image placeholder" src="{{asset('assets\images\avatars\avatar-2.jpeg')}}" class="avatar  rounded-circle avatar-lg">
                ...
                <li>
                        ...
                        <div class="card-body text-center">
                            <div class="avatar-parent-child">
                                <img alt="Image placeholder" src="{{asset('assets\images\avatars\avatar-1.jpeg')}}" class="avatar  rounded-circle avatar-lg">
                                <span class="avatar-child avatar-badge bg-success"></span>
                            </div>
...
<div class="bg-white uk-card-default uk-height-1-1" data-simplebar="" uk-sticky="offset:70; bottom:true">
...
<div class="p-3">
    ...
    <div class="uk-grid-small uk-flex-middle" uk-grid="">
        <div class="uk-width-auto"> <img class="rounded border border-200" src="{{asset('assets\images\course\2.png')}}" width="60" alt=""> </div>
        <div class="uk-width-expand">
    ...
    <div class="uk-grid-small uk-flex-middle" uk-grid="">
        <div class="uk-width-auto"> <img class="rounded border border-200" src="{{asset('assets\images\course\2.png')}}" width="80" alt=""> </div>
        <div class="uk-width-expand">
            <p class="uk-text-truncate mb-0"> Javascript for Begginers</p>
