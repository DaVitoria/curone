            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{route('auto.pain')}}"></a>Concursos</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row special-list">
                    ...
                    <div class="col-lg-3 col-md-6 special-grid top-featured">
                        <div class="products-single fix">
                            ...
                            <div class="why-text">
                                <h3><strong>Agente do Serviço</strong></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 special-grid top-featured">
                        <div class="products-single fix">
                            ...
                            <div class="why-text">
                                <h3><strong>Técnico do Serviço</strong></h3>
                            </div>
                        </div>
                    </div>
                </div>
